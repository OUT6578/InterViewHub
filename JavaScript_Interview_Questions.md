...
> **Note**: This document contains a collection of tricky JavaScript interview questions focusing on Event Loop, Promises, Async/Await, and Array operations.
...
## 😵‍💫 Q15 – setInterval + heavy sync block - setInterval(() => {
...
## 😵‍💫 Q13 – empty array reduce - [].reduce((a, b) => a + b);
